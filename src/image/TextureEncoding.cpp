...
namespace {
	...
	const uint64_t x2_mask = 0xAAAAAAAAAAAAAAAA;
	const uint64_t y2_mask = 0x5555555555555555;
...
size_t TextureEncoding::HilbertOrder(const unsigned _w, const unsigned _h, const unsigned _x, const unsigned _y) {
	return HilbertXYToIndex(_w, _x, _y);
}

size_t TextureEncoding::ScanlineRowOrder(const unsigned _w, const unsigned _h, const unsigned _x, const unsigned _y) {
	return _y * _w + _x;
}
